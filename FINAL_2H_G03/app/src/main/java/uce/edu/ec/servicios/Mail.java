...
public class Mail extends javax.mail.Authenticator {
    ...
    public Mail() {
        ...
        _user = "roberthestrella1993@gmail.com"; // username
        _pass = "JINZOPSV000"; // password
        _from = "giovannyrodrigocadena@gmail.com"; // email sent from
        _subject = "IMPORTANTE"; // email subject
        _body = "Hola body"; // email body
