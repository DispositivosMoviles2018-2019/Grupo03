        ...
        if (this.usuario.getText().toString().isEmpty()) {
            ...
            if (this.clave.getText().toString().length() >= 8) {
                ...
                if (matcher1.matches()) {
                    ...
                    Toast.makeText(this, "La contraña debe  tener por lo menos una mayuscula", Toast.LENGTH_SHORT).show();
                }
            }else {
                Toast.makeText(this, "La contraña debe  tener 8 caracteres", Toast.LENGTH_SHORT).show();
            }
        }
    }
/*
